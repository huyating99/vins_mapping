...
#ifndef BETA_RIGID_TRANSFORM_H
#define BETA_RIGID_TRANSFORM_H
    ...
    namespace transform{
        ...
        public:
            ...
            std::string DebugString() const {
                return printf("{ t: [$0, $1], r: [$2] }", translation().x(),
...
// This is needed for gmock.
        ...
        std::ostream& operator<<(std::ostream& os,
                                 const mapping::transform::Rigid2<T>& rigid) {
        ...
        public:
            ...
            std::string DebugString() const {
                return printf("{ t: [$0, $1, $2], q: [$3, $4, $5, $6] }",
...
// This is needed for gmock.
        template <typename T>
        std::ostream& operator<<(std::ostream& os,
                                 const mapping::transform::Rigid3<T>& rigid) {
            os << rigid.DebugString();
            return os;
        }
